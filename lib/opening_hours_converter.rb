module OpeningHoursConverter
  ...
  require_relative './opening_hours_converter/period_tip'
  require_relative './opening_hours_converter/period'
  require_relative './opening_hours_converter/period_list'
