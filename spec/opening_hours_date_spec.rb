...
RSpec.describe OpeningHoursConverter::OpeningHoursDate, '#initialize' do
  it "initialize" do
    ...
    expect { OpeningHoursConverter::OpeningHoursDate.new(
      OpeningHoursConverter::WideInterval.new.day(21, 4, nil, 22, 8), [0,1,3,5,6])
    }.to_not raise_error
  end
end
RSpec.describe OpeningHoursConverter::OpeningHoursDate, '#get_weekdays' do
  it "sorted" do
    ohd = OpeningHoursConverter::OpeningHoursDate.new(
      OpeningHoursConverter::WideInterval.new.day(21, 4, nil, 22, 8), [0,1,3,5,6])
  ...
  it "unsorted" do
    ohd = OpeningHoursConverter::OpeningHoursDate.new(
      OpeningHoursConverter::WideInterval.new.day(21, 4, nil, 22, 8), [6,3,1,5,0])
    expect(ohd.weekdays[0]).to eql(0)
    expect(ohd.weekdays[1]).to eql(1)
    expect(ohd.weekdays[2]).to eql(3)
    expect(ohd.weekdays[3]).to eql(5)
...
RSpec.describe OpeningHoursConverter::OpeningHoursDate, '#same_kind_as?' do
  it "ok" do
    ohd = OpeningHoursConverter::OpeningHoursDate.new(
      OpeningHoursConverter::WideInterval.new.day(21, 4, nil, 22, 8), [0,1,2,4,5,6])

    ohd1 = OpeningHoursConverter::OpeningHoursDate.new(
      OpeningHoursConverter::WideInterval.new.day(1, 3, nil, 2, 4), [0,1,2,4,5,6])
    expect(ohd.same_kind_as?(ohd1)).to be true
  end
  it "not ok" do
    ohd = OpeningHoursConverter::OpeningHoursDate.new(
      OpeningHoursConverter::WideInterval.new.day(21, 4, nil, 22, 8), [0,1,2,3,5,6])
    ohd1 = OpeningHoursConverter::OpeningHoursDate.new(
      OpeningHoursConverter::WideInterval.new.day(1, 3, nil, 2, 4), [0,1,4,5,6])
...
RSpec.describe OpeningHoursConverter::OpeningHoursDate, '#equals?' do
  ...
  it "not same" do
    ohd = OpeningHoursConverter::OpeningHoursDate.new(
      OpeningHoursConverter::WideInterval.new.day(21, 4, nil, 22, 8), [0,1,2,4,5,6])
    ohd1 = OpeningHoursConverter::OpeningHoursDate.new(OpeningHoursConverter::WideInterval.new.always, [0,1,2,4,5,6])
...
RSpec.describe OpeningHoursConverter::OpeningHoursDate, '#add_weekday' do
  it "new" do
    ohd = OpeningHoursConverter::OpeningHoursDate.new(
      OpeningHoursConverter::WideInterval.new.day(21, 4, nil, 22, 8), [0])
  ...
  it "existing" do
    ohd = OpeningHoursConverter::OpeningHoursDate.new(
      OpeningHoursConverter::WideInterval.new.day(21, 4, nil, 22, 8), [0, 3])
    expect(ohd.weekdays.length).to eql(2)
...
RSpec.describe OpeningHoursConverter::OpeningHoursDate, '#add_overwritten_weekday' do
  ...
  it "existing" do
    ohd = OpeningHoursConverter::OpeningHoursDate.new(
      OpeningHoursConverter::WideInterval.new.day(21, 4, nil, 22, 8), [0, 2])
    expect(ohd.get_weekdays).to eql("Mo,We")
...
RSpec.describe OpeningHoursConverter::OpeningHoursDate, '#get_weekdays' do
  it "1" do
    ohd = OpeningHoursConverter::OpeningHoursDate.new(
      OpeningHoursConverter::WideInterval.new.day(21, 4, nil, 22, 8), [0,1,3,5])
    expect(ohd.get_weekdays).to eql("Mo,Tu,Th,Sa")
  end
  it "2" do
    ohd = OpeningHoursConverter::OpeningHoursDate.new(
      OpeningHoursConverter::WideInterval.new.day(21, 4, nil, 22, 8), [0,1,4,3,2,5])
    expect(ohd.get_weekdays).to eql("Mo-Sa")
  end
  it "3" do
    ohd = OpeningHoursConverter::OpeningHoursDate.new(
      OpeningHoursConverter::WideInterval.new.day(21, 4, nil, 22, 8), [0,6])
    expect(ohd.get_weekdays).to eql("Mo,Su")
  end
  it "4-1" do
    ohd = OpeningHoursConverter::OpeningHoursDate.new(
      OpeningHoursConverter::WideInterval.new.day(21, 4, nil, 22, 8), [6,0,1])
    expect(ohd.get_weekdays).to eql("Su-Tu")
  end
  it "4-2" do
    ohd = OpeningHoursConverter::OpeningHoursDate.new(
      OpeningHoursConverter::WideInterval.new.day(21, 4, nil, 22, 8), [5,6,0,1,3])
    expect(ohd.get_weekdays).to eql("Sa-Tu,Th")
  end
  it "4-3" do
    ohd = OpeningHoursConverter::OpeningHoursDate.new(
      OpeningHoursConverter::WideInterval.new.day(21, 4, nil, 22, 8), [0, 3, 6])
    expect(ohd.get_weekdays).to eql("Mo,Th,Su")
  end
  it "4-4" do
    ohd = OpeningHoursConverter::OpeningHoursDate.new(
      OpeningHoursConverter::WideInterval.new.day(21, 4, nil, 22, 8), [0,1,2,3,4,5,6])
