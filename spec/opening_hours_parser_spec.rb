...
RSpec.describe OpeningHoursConverter::OpeningHoursParser, '#parse' do
  ...
  it "Mo,Tu,PH off" do
    expect(OpeningHoursConverter::OpeningHoursBuilder.new.build(OpeningHoursConverter::OpeningHoursParser.new.parse("Mo,Tu,PH off"))).to eql("Mo,Tu off; PH off")
  end
  it "Jan off" do
  ...
  # it "2017 Mo 10:00-24:00, Tu-Fr 00:00-24:00, Sa 00:00-12:00" do
  #   expect(OpeningHoursConverter::OpeningHoursBuilder.new.build(OpeningHoursConverter::OpeningHoursParser.new.parse("2017 Mo 10:00-24:00, Tu-Fr 00:00-24:00, Sa 00:00-12:00"))).to eql("2017 Mo 10:00-24:00, Tu-Fr 00:00-24:00, Sa 00:00-12:00")
  # end

  # it "Dec 25 off; Dec 26 00:00-23:59;" do
  #   expect(OpeningHoursConverter::OpeningHoursParser.new.parse("24/7; Mo 10:00-20:00 off")).to eql(OpeningHoursConverter::OpeningHoursParser.new.parse("24/7; Mo 00:00-10:00,20:00-24:00"))
  # end
