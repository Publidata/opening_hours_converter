...
RSpec.describe OpeningHoursConverter::OpeningHoursParser, '#parse' do
  ...
  it "Mo 08:00-18:00 grouping with a year" do
    expect(OpeningHoursConverter::OpeningHoursBuilder.new.build(OpeningHoursConverter::OpeningHoursParser.new.parse('Mo 08:00-18:00; 2017 Jun: Mo 08:00-18:00'))).to eql('Mo 08:00-18:00')
  end
