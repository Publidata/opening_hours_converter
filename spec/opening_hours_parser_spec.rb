...
RSpec.describe OpeningHoursConverter::OpeningHoursParser, '#parse' do
  ...
  #   expect(OpeningHoursConverter::OpeningHoursBuilder.new.build(OpeningHoursConverter::OpeningHoursParser.new.parse('Tu-We 10:00-20:00;Tu off'))).to eql('We 10:00-20:00')
  # end
  ...
  #   expect(OpeningHoursConverter::OpeningHoursBuilder.new.build(OpeningHoursConverter::OpeningHoursParser.new.parse("Mo off; Tu 10:00-11:00"))).to eql("Tu 10:00-11:00")
  # end
  # it "Mo,We off; Tu 10:00-11:00" do
  #   expect(OpeningHoursConverter::OpeningHoursBuilder.new.build(OpeningHoursConverter::OpeningHoursParser.new.parse("Mo,We off; Tu 10:00-11:00"))).to eql("Tu 10:00-11:00")
  # end
  ...
  it "Mo,Tu,PH off" do
    expect(OpeningHoursConverter::OpeningHoursBuilder.new.build(OpeningHoursConverter::OpeningHoursParser.new.parse("Mo,Tu,PH off"))).to eql("Mo,Tu,PH off")
  end
  it "Jan off" do
  ...
  it "Jan We 11:00-12:00,Mo off" do
    expect(OpeningHoursConverter::OpeningHoursBuilder.new.build(OpeningHoursConverter::OpeningHoursParser.new.parse("Jan We 11:00-12:00,Mo off"))).to eql("Jan We 11:00-12:00,Mo off")
  end
  it "Jan Su off,Mo-Sa 11:00-12:00" do
    expect(OpeningHoursConverter::OpeningHoursBuilder.new.build(OpeningHoursConverter::OpeningHoursParser.new.parse("Jan Su off,Mo-Sa 11:00-12:00"))).to eql("Jan Su off,Mo-Sa 11:00-12:00")
  end
