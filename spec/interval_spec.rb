...
RSpec.describe OpeningHoursConverter::Interval, "#initialize" do
  it "initialize" do
    interval = OpeningHoursConverter::Interval.new(1, 2, 3, 4)
  ...
  it "initialize" do
    interval = OpeningHoursConverter::Interval.new(5, 60, 0, 0)
